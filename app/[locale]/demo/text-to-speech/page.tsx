...
import { TextToSpeechApiDemo } from "@/components/text-to-speech-api-demo";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: "TTS API demo",
    description: "Internal Text-to-speech API demo for creating and polling DeVoice text-to-speech jobs.",
    alternates: {
      canonical,
